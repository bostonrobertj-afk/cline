...
<step n="1" goal="Review the current PRD state">
...
<step n="7" goal="Review, save, and continue">
  ...
  <ask>Present the continuation menu for moving to functional requirements.</ask>
  <action>If the user chooses to continue, append this step to `stepsCompleted` and load `./step-09-functional.md`.</action>
</step>
