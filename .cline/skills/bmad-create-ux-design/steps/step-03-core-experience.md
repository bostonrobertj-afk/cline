  ...
  <branch if="the user chooses Advanced Elicitation" optional="true">
    <action>
      ...
      <detail>
        ...
        Prompt the subagent with the current core-experience draft and the instruction to deepen key interactions, friction points, or delight moments.
  ...
  <branch if="the user chooses Party Mode" optional="true">
    <action>
      ...
      <detail>
        ...
        Prompt the subagent with the current core-experience draft and the instruction to critique it from multiple stakeholder perspectives.
