  ...
  <branch if="the user chooses Advanced Elicitation" optional="true">
    <action>
      ...
      <detail>
        ...
        Prompt the subagent with the current visual-foundation draft and the instruction to deepen typography, color, hierarchy, or surface guidance.
  ...
  <branch if="the user chooses Party Mode" optional="true">
    <action>
      ...
      <detail>
        ...
        Prompt the subagent with the current visual-foundation draft and the instruction to critique it from multiple stakeholder perspectives.
