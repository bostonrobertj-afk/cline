...
<step n="3" goal="Draft, review, and save the design-directions section">
  ...
  <branch if="the user chooses Advanced Elicitation" optional="true">
    <action>Invoke `bmad-advanced-elicitation` using the design-directions draft as context.</action>
  </branch>
  <branch if="the user chooses Party Mode" optional="true">
    <action>Invoke `bmad-party-mode` using the design-directions draft as context.</action>
  </branch>
