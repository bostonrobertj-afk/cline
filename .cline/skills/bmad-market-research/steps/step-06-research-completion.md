...
<step n="2" goal="Assemble the final market research structure">
  <action>Organize the finished document into a coherent final flow.</action>
  <detail>
    The final document should include a compelling title, an executive summary, a table of contents when appropriate, integrated market/customer/competitive analysis, strategic recommendations, risk and implementation guidance, and methodology or source notes where needed.
  </detail>
</step>
...
<step n="3" goal="Write the final synthesis and recommendations">
  ...
  <detail>
    Connect the major findings across customer behavior, pain points, decision processes, and competition.
...
<step n="5" goal="Handle completion confirmation">
  <ask>Ask the user to choose `[C] Complete` to finalize the market research workflow or provide final corrections first.</ask>
