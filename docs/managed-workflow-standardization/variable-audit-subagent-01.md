...
## Assigned Workflows
- `cline-skills/bmad-advanced-elicitation`
- `cline-skills/bmad-brainstorming`
- `cline-skills/bmad-check-implementation-readiness`
- `cline-skills/bmad-cis-design-thinking`
- `cline-skills/bmad-cis-innovation-strategy`
- `cline-skills/bmad-cis-problem-solving`
- `cline-skills/bmad-cis-storytelling`
