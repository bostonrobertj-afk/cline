...
## Assigned Workflows
- `cline-skills/bmad-correct-course`
- `cline-skills/bmad-create-architecture`
- `cline-skills/bmad-create-epics-and-stories`
- `cline-skills/bmad-create-prd`
- `cline-skills/bmad-create-product-brief`
- `cline-skills/bmad-create-story`
