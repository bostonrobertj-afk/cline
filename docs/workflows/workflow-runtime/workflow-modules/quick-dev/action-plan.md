...
[ ] Task 4: Add `/Users/robertboston/Documents/Cline Extension/cline/src/core/task/workflow-runtime/workflow-modules/quick-dev/quickDevWorkflow.ts` imports, identity constants, workflow values, prerequisite declaration, setup procedure, prompt constants, decision trees, and workflow definition.
