...
import { getCodeExplorationGuidance } from "./mcp"
...
const getRulesTemplateText = (context: SystemPromptContext) => {
...
- ${context.yoloModeToggled !== true ? "Use the ask_followup_question tool when a direct answer from the user would improve correctness, reduce risk, or unblock the next step. Keep the question clear and concise, but treat clarifying dialogue as a normal part of collaboration rather than an exceptional fallback. If tools can answer the question directly, prefer using tools first." : "Use your available tools and apply your best judgment to accomplish the task without asking the user any followup questions, making reasonable assumptions from the provided context"}. For example, if the user mentions a file that may be in an outside directory like the Desktop, you should use the list_files tool to list the files in the Desktop and check if the file they are talking about is there, rather than asking the user to provide the file path themselves.
