...
export const PLACEHOLDER_WORKFLOW_STEP_MATRIX: Record<string, Record<number, readonly PlaceholderToolBundle[]>> = {
	...
	"code-review.md": {
		...
		3: ["DOC_READ", "LOCAL_EXEC", "DIFF_BUILD"],
		4: ["PLACEHOLDER_WRITE"],
	...
	"create-architecture.md": {
		1: ["DOC_READ", "DOC_WRITE"],
		2: ["DOC_READ", "DOC_WRITE"],
		3: ["DOC_READ", "DOC_WRITE", "EXTERNAL_RESEARCH"],
		4: ["DOC_WRITE"],
		5: ["DOC_WRITE"],
		6: ["DOC_WRITE"],
		7: ["DOC_READ"],
	...
	"create-epics-and-stories.md": {
		1: ["DOC_READ"],
		2: ["DOC_READ", "DOC_WRITE"],
		3: ["DOC_WRITE", "WORKFLOW_ROUTE"],
		4: ["DOC_WRITE", "WORKFLOW_ROUTE"],
		5: ["DOC_READ"],
	},
	"create-prd.md": {
		1: ["DOC_READ", "DOC_WRITE"],
	...
	"create-product-brief.md": {
		1: ["DOC_READ", "DOC_WRITE"],
		2: ["DOC_WRITE", "WORKFLOW_ROUTE"],
		3: ["DOC_WRITE", "WORKFLOW_ROUTE"],
		4: ["DOC_WRITE", "WORKFLOW_ROUTE"],
		5: ["DOC_WRITE", "WORKFLOW_ROUTE"],
		6: ["DOC_READ"],
	},
	"create-story.md": {
		1: ["DOC_READ", "DOC_WRITE"],
	...
	"dev-story.md": {
		...
		2: ["DOC_READ"],
		3: [],
		4: ["CODE_READ", "INDXR_DISCOVERY", "INDXR_SOURCE_READ", "INDXR_SYMBOL_GRAPH", "DOC_WRITE", "LOCAL_EXEC"],
		5: ["CODE_READ", "INDXR_DISCOVERY", "INDXR_SOURCE_READ", "INDXR_SYMBOL_GRAPH", "DOC_WRITE", "LOCAL_EXEC"],
		6: ["DOC_READ", "DOC_WRITE", "LOCAL_EXEC"],
	},
	"distillator.md": {
		1: ["DOC_READ"],
	...
	"domain-research.md": {
		1: ["DOC_READ", "DOC_WRITE"],
		2: ["EXTERNAL_RESEARCH", "DOC_WRITE"],
		3: ["EXTERNAL_RESEARCH", "DOC_WRITE"],
		4: ["EXTERNAL_RESEARCH", "DOC_WRITE"],
		5: ["EXTERNAL_RESEARCH", "DOC_WRITE"],
	...
	"quick-dev.md": {
		...
		6: ["CODE_READ", "INDXR_DISCOVERY", "INDXR_SOURCE_READ", "INDXR_SYMBOL_GRAPH", "DOC_WRITE"],
	},
	"quick-spec.md": {
		1: ["DOC_READ", "DOC_WRITE"],
		2: ["CODE_READ", "INDXR_DISCOVERY", "INDXR_SOURCE_READ", "INDXR_SYMBOL_GRAPH", "DOC_WRITE"],
	...
	"review-edge-case-hunter.md": {
		1: ["DOC_READ"],
		2: ["CODE_READ", "INDXR_DISCOVERY", "INDXR_SOURCE_READ", "INDXR_SYMBOL_GRAPH"],
		3: ["CODE_READ", "INDXR_DISCOVERY", "INDXR_SOURCE_READ", "INDXR_SYMBOL_GRAPH"],
		4: [],
	},
	"shard-doc.md": {
		1: ["DOC_READ"],
