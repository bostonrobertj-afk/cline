...
export const PLACEHOLDER_BUILTIN_BUNDLE_TOOLS = {
	...
	EPIC_DELIVERY_SPEC_BUILD: [ClineDefaultTool.BUILD_EPIC_DELIVERY_SPEC],
	STORY_DOCUMENT_BUILD: [ClineDefaultTool.BUILD_STORY_DOCUMENT],
...
export const PLACEHOLDER_WORKFLOW_STEP_MATRIX: Record<string, Record<number, readonly PlaceholderToolBundle[]>> = {
	...
	"dev-story.md": {
		1: ["DOC_READ", "PLACEHOLDER_WRITE"],
		2: ["DOC_READ", "DOC_WRITE", "CODE_READ", "LOCAL_EXEC", "STORY_TASK_EXECUTION"],
		3: [
			"DOC_READ",
			"DOC_WRITE",
			"CODE_READ",
	...
	"review-adversarial-general.md": {
		1: ["DOC_READ"],
		2: ["DOC_READ", "CODE_READ", "INDXR_DISCOVERY", "INDXR_SOURCE_READ"],
		3: [],
	},
	"blind-review.md": {
		1: ["DOC_READ", "PLACEHOLDER_WRITE"],
		2: ["DOC_READ", "CODE_READ", "INDXR_DISCOVERY", "INDXR_SOURCE_READ", "DOC_WRITE"],
		3: [],
	},
	"review-edge-case-hunter.md": {
		1: ["DOC_READ"],
		2: ["DOC_READ", "CODE_READ", "INDXR_DISCOVERY", "INDXR_SOURCE_READ"],
		3: ["DOC_READ", "CODE_READ", "INDXR_DISCOVERY", "INDXR_SOURCE_READ"],
		4: [],
	},
	"shard-doc.md": {
		1: ["DOC_READ"],
