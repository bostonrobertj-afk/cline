...
const generic: ClineToolSpec = {
	...
	name: "use_skill",
	description:
		"Load and activate a skill, workflow, or managed workflow by name. Use this tool when the current task requires one of the available skills or workflow activations shown in the SKILLS section of your system prompt. If a parent active-agent prompt says workflow activation must happen through a subagent, follow that instruction and call use_skill from the subagent instead of the current thread. After activation, follow the returned or injected instructions directly and do not call use_skill again unless a later step explicitly requires a different workflow.",
