...
- ${getCodeExplorationGuidance(
	context,
	"For code investigation, prefer this order when possible: search_files to narrow candidate files, list_code_definition_names to map relevant symbols and line numbers, read_file for the first full-file pass, and read_file_range for targeted follow-up checks. Avoid rereading large files in full when a focused range will do.",
)}
