...
const CREATE_ARCHITECTURE_TOOL_SCHEMA_VARIANT = ModelFamily.NATIVE_GPT_5

export function buildCreateArchitectureStep1ToolSchemas(): readonly ClineToolSpec[] {
	return []
}

export function buildCreateArchitectureStep2ToolSchemas(): readonly ClineToolSpec[] {
	return []
}

export function buildCreateArchitectureReadFileToolSchema(): ClineToolSpec {
	return {
		variant: CREATE_ARCHITECTURE_TOOL_SCHEMA_VARIANT,
...
export function buildCreateArchitectureReadFileRangeToolSchema(): ClineToolSpec {
	return {
		variant: CREATE_ARCHITECTURE_TOOL_SCHEMA_VARIANT,
...
export function buildCreateArchitectureListFilesToolSchema(): ClineToolSpec {
	return {
		variant: CREATE_ARCHITECTURE_TOOL_SCHEMA_VARIANT,
...
export function buildCreateArchitectureSearchFilesToolSchema(): ClineToolSpec {
	return {
		variant: CREATE_ARCHITECTURE_TOOL_SCHEMA_VARIANT,
...
export function buildCreateArchitectureListCodeDefinitionNamesToolSchema(): ClineToolSpec {
	return {
		variant: CREATE_ARCHITECTURE_TOOL_SCHEMA_VARIANT,
...
export function buildCreateArchitectureApplyPatchToolSchema(): ClineToolSpec {
	return {
		variant: CREATE_ARCHITECTURE_TOOL_SCHEMA_VARIANT,
...
export function buildCreateArchitectureSendUserMessageToolSchema(): ClineToolSpec {
	return {
		variant: CREATE_ARCHITECTURE_TOOL_SCHEMA_VARIANT,
...
export function buildCreateArchitectureAskFollowupQuestionToolSchema(): ClineToolSpec {
	return {
		variant: CREATE_ARCHITECTURE_TOOL_SCHEMA_VARIANT,
...
export function buildCreateArchitectureWorkflowProgressRequestToolSchema(): ClineToolSpec {
	return {
		variant: CREATE_ARCHITECTURE_TOOL_SCHEMA_VARIANT,
		id: ClineDefaultTool.WORKFLOW_PROGRESS_REQUEST,
		name: "workflow_progress_request",
		description: "Ask the user to confirm whether the current create-architecture workflow step is ready to advance.",
		parameters: [],
	}
}

export function buildCreateArchitectureAttemptCompletionToolSchema(): ClineToolSpec {
	return {
		variant: CREATE_ARCHITECTURE_TOOL_SCHEMA_VARIANT,
		id: ClineDefaultTool.ATTEMPT,
		name: "attempt_completion",
		description: "Deliver the final create-architecture completion message to the user.",
		parameters: [
			{
				name: "result",
				required: true,
...
export function buildCreateArchitectureStep3ToolSchemas(): readonly ClineToolSpec[] {
	return [
		buildCreateArchitectureReadFileToolSchema(),
		buildCreateArchitectureApplyPatchToolSchema(),
		buildCreateArchitectureSendUserMessageToolSchema(),
		buildCreateArchitectureAskFollowupQuestionToolSchema(),
		buildCreateArchitectureWorkflowProgressRequestToolSchema(),
	]
}

export function buildCreateArchitectureStep4ToolSchemas(): readonly ClineToolSpec[] {
	return [
		buildCreateArchitectureListFilesToolSchema(),
		buildCreateArchitectureSearchFilesToolSchema(),
		buildCreateArchitectureListCodeDefinitionNamesToolSchema(),
		buildCreateArchitectureReadFileToolSchema(),
		buildCreateArchitectureReadFileRangeToolSchema(),
		buildCreateArchitectureApplyPatchToolSchema(),
		buildCreateArchitectureSendUserMessageToolSchema(),
		buildCreateArchitectureAskFollowupQuestionToolSchema(),
		buildCreateArchitectureWorkflowProgressRequestToolSchema(),
...
export const buildCreateArchitectureStep5ToolSchemas = buildCreateArchitectureStep4ToolSchemas
export const buildCreateArchitectureStep6ToolSchemas = buildCreateArchitectureStep4ToolSchemas
export const buildCreateArchitectureStep7ToolSchemas = buildCreateArchitectureStep4ToolSchemas
export const buildCreateArchitectureStep8ToolSchemas = buildCreateArchitectureStep4ToolSchemas

export function buildCreateArchitectureStep9ToolSchemas(): readonly ClineToolSpec[] {
	return [
		buildCreateArchitectureReadFileToolSchema(),
		buildCreateArchitectureApplyPatchToolSchema(),
		buildCreateArchitectureSendUserMessageToolSchema(),
		buildCreateArchitectureAskFollowupQuestionToolSchema(),
		buildCreateArchitectureAttemptCompletionToolSchema(),
	]
}
